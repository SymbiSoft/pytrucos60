...
# Created on:      29-jul-2011 20:15:39
...
class Jogo(cocos.layer.Layer, EventDispatcher): # must be layer - scene causes anims/actions to fail
    ...
    def informaFimMao(self):
        print "Vou informar do fim da Mão!"
        for jogador in self.mesa.jogadores:
            respFimMao = {}
            jogador.envia_comandoJS({'fim':'mao'})
            ...
            if 'truco' in cmd:
                if cmd['truco'] == 'pedido':
                    ...
                    if self.statusMao == 0:
                        ...
                        self.mesa.jogadores[ordem+1].envia_comandoJS({'truco':'aceita?'})
                        ...
                        if cmd1 == 'sim':
                            ...
                            for jogador in self.mesa.jogadores:
                                if not jogador.vezDeJogar:
                                    jogador.envia_comando("jogador %s aceitou o truco" % self.mesa.jogadores[ordem+1].nome)
    ...
    def animaDescartar(self, carta, jogador):
        ...
        move = MoveTo((posDesc1,posDesc2), duration=5)
