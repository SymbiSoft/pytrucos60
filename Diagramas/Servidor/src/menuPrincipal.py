...
# 
# menuPrincipal.py
# Python implementation of the Class MenuPrincipal
# Generated by Enterprise Architect
# Created on:      26-jul-2011 20:16:25
...
class MenuPrincipal( Menu ):
    ...
    def __init__(self):
        ...
        items.append( MenuItem(u'Opções', self.on_opcoes) )
        items.append( MenuItem(u'Créditos', self.on_creditos) )
